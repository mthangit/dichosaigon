...
@section('content')
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="padding-left:0;width:100%"><button class="button"
                                                            onclick="window.location='/createpost'">Đăng tin</button>
                                                    </td>
    ...
    <script>
        function editProduct(productId) {
            window.location = '/editpost/' + productId;
        }

        function deleteProduct(productId) {
            var confirmDelete = confirm('Bạn có chắc chắn muốn xóa sản phẩm có ID là ' + productId);
            if (confirmDelete) {
